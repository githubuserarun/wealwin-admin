...
const ProductTable = ({ products ,updateProducts}) => {
  ...
  let filteredProducts = subCategoryData.filter(cat => cat.categoryId.category === category)

  const onchangeCategory = (e) => {

    
    //setCategoryId(e.target.value); // Accessing category._id
    setCategory(e.target.value); // Accessing category.category
